...
export const AppertizerList = [
    ...
    {
        name:"Gà Nướng hay Sườn Nướng Không",
        price:"6",
        description:"Grilled Chicken or Pork Chops"
    }
]
...
export const SpecialNoodleList = [
    {
        name:"Phở Gà",
        price:"14",
        description:"Free Range Chicken Noodle Soup"
    },
    {
        name:"Phở Gà Đặc Biệt",
        price:"14",
        description:"Free Range Chicken, Chicken Balls, Quail Egg Noodle Soup"
    },
    {
        name:"Hủ Tiếu Đồ Biển Khô/Nước (Tôm, Cua, Chả Cá)",
        price:"14",
        description:"Seafood Rice Noodle (Shrimp, crab meat, fried fish cake (Soup/Dried)"
    },
    {
        name:"Mì Đồ Biển/Khô/Nước (Tôm, Cua, Chả Cá)",
        price:"14",
        description:"Seafood Egg Noodle (Shrimp, crab meat, fried fishcake --Soup/Dried)"
    },
    {
        name:"Phở Bò Kho",
        price:"14",
    ...
    },
    {
        name:"Bánh Mì Bò Kho",
        price:"14",
        description:"Beef Stew with French Bread"
    },
    {
        name:"Cơm Bò Kho",
        price:"14",
...
export const SpecialList = [
    {
        name:"Combo A/ Phở đặc biệt (L) + Chả Giò Hoặc Gỏi Cuốn",
        price:"16",
        description:"Special Beef Noodle Soup + Spring Roll or Salad Roll"
    },
    {
        name:"Combo B/ Cơm Gà Hoặc Sườn + Chả Giò Hoặc Gỏi Cuốn",
        price:"17",
        description:"Grilled Chicken or Pork Chop on Rice + Spring Roll or Shrimp"
    }
]
